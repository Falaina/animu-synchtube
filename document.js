...
var html = 
'<link href="//dl.dropbox.com/u/78728596/test/cssbanner/synchbanner2.css" rel="stylesheet" />'+
'<link href="//dl.dropbox.com/u/78728596/synchtube/ChristmasTheme.css" rel="stylesheet" />'+
'<link href="//dl.dropbox.com/u/78728596/synchtube/special.css" rel="stylesheet" />'+
...
$(".rotate").click(function(){
 ...
 //Theme switch
    ...
    $(".themeMuki").click(function(){
		$('.customTheme').html('<link href="//dl.dropbox.com/u/78728596/synchtube/mikuTheme.css" rel="stylesheet"/>');
    });
    $(".themeSteinsGate").click(function(){
		$('.customTheme').html('<link href="//dl.dropbox.com/u/78728596/synchtube/steinsTheme.css" rel="stylesheet"/>');
    });
    $(".themeHalloween").click(function(){
		$('.customTheme').html('<link href="//dl.dropbox.com/u/78728596/synchtube/HalloweenTheme.css" rel="stylesheet"/>');
    });
    $(".themeChristmas").click(function(){
		$('.customTheme').html('<link href="//dl.dropbox.com/u/78728596/synchtube/ChristmasTheme.css" rel="stylesheet"/>');
    });
