setupFilters = function() {       
	...
	word_filters = [  	  
	  ...
	  {pat : /\bn(i|l)gger\b/ig,				target : 'caucasian'},
	  {pat : /\bn(i|l)ggers\b/ig,				target : 'caucasians'},	  
	  {pat : /homura/ig,					target : 'hameru'},
	  {pat : /mami/ig,					target : 'mumi'},
	  {pat : /kyoko/ig,					target : 'kyaku'},
	  {pat : /\b(everybody|everyone)\b/ig,				target : 'everywanker'},
	  ...
	  {pat : /\b(l|i)(e|е)(l|i)\b/ig, 			target : 'XD'},
	  ...
	  (pat : /\b( ͡° ͜ʖ ͡°/ig,					target : '(✖\'_____________________________________\')'},
