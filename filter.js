	...
	var word_filters = [  	  
	  ...
	  {pat : /\bnigger/ig,		 			target : 'friend'},	  
	  {pat : /\bfuck/ig,		 			target : 'love'},	  
	  {pat : /\bwaifus\b/ig,				target : 'wives'},
	  ...
	  {pat : /\bautis(m|tic)\b/ig,				target : 'moe'},
          ...
          {pat : /\b(fag|fagg(e|o)t)\b/ig,			target : 'bro'},
	  {pat : /\b(dick|cock)\b/ig,				target : 'rampaging stick of meat'},                    
          {pat : /\b(fags|fagg(e|o)ts)\b/ig,			target : 'bros'},	  
